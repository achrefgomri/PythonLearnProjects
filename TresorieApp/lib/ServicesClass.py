...
class ServiceMouvement:
	...
	def insert (cls,m_object):
		Tresorie=ConnectionClass.ConnectSQL()
                Tresorie.execute('INSERT INTO mouvement ({},{},{},{},{},{}) VALUES ({},{},{},{},{},{})'.format('type','nature','id_caisse','valeur','motif','date_valeur',m_object.type,m_object.nature,m_object.id_caisse,m_object.valeur,m_object.motif,m_object.date_valeur))
...
class ServiceCaisse:
	...
	def insert (cls,c_object):
                Tresorie=ConnectionClass.ConnectSQL()
                Tresorie.execute('INSERT INTO mouvement ({},{},{},{}) VALUES ({},{},{},{})'.format('nom','valeur','date_creation','commentaire',c_object.nom,c_object.valeur,c_object.date_creation,c_object.commentaire))
